...
| backend-architect | API, database, integration design | Sonnet |
| frontend-architect | Pages, modules, data fetching | Sonnet |
...
| migration-checker | Migration safety, reversibility | Sonnet |
...
| env-config-analyst | Environment, external APIs, config | Sonnet |
...
| Agent | Role | Model |
|-------|------|-------|
| backend-worker | Backend tasks (Express routes, agents, services) | Sonnet |
| frontend-worker | Frontend tasks (pages, public assets, JS modules) | Sonnet |
