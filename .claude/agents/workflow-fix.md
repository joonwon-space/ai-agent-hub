...
- `backend/src/routes/auth*` (authentication routes)
- `backend/src/agents/**` (agent definitions and orchestration)
- Anything touching secrets, env vars, or external API credentials
...
- Auth/credential bugs are always CRITICAL severity
