...
- `[security]`, `[auth]`, `[migration]`, `[secret]`, `[credentials]`
- Any item mentioning: 인증, 암호화, 비밀번호, 토큰, refresh token, API 키, 시크릿

**If ANY such items are found:**
1. Print warning: "tasks.md에 보안/인증 관련 항목이 포함되어 있습니다. `/sprint`를 사용해주세요."
