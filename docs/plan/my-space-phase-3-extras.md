...
> **⚠️ 본 문서는 historical record 입니다.**
> Phase 3 의 모든 메인 항목 (3.1 / 3.2 / 3.3 / 3.4 / 3.5) 은 main 에 머지 완료되었고,
> 잔여 후속 작업은 [`docs/plan/backlog.md`](./backlog.md) 로 이관되었습니다.
> 새 후속 작업 추가 시 본 문서가 아닌 backlog.md 를 갱신하세요.

소스 PRD: [docs/prd/my-space.md](../prd/my-space.md) §10
이 문서는 Phase 1 / 1.5 / 2 (Notes) 이후로 미뤄진 항목들의 **초기 백로그 초안**이었다. 각 항목별로 PRD 보강과 디자인 검증이 선행되어야 한다는 가정 하에 작성됐다.
